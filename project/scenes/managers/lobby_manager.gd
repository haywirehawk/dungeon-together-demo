...
func _ready() -> void:
	...
	if multiplayer.multiplayer_peer is OfflineMultiplayerPeer:
		...
		# TODO: Investigate making a separate start_singleplayer function called in main
